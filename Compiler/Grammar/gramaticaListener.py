...
class gramaticaListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by gramaticaParser#lectura_archivo.
    def enterLectura_archivo(self, ctx:gramaticaParser.Lectura_archivoContext):
        pass

    # Exit a parse tree produced by gramaticaParser#lectura_archivo.
    def exitLectura_archivo(self, ctx:gramaticaParser.Lectura_archivoContext):
        pass


    # Enter a parse tree produced by gramaticaParser#escritura_archivo.
    def enterEscritura_archivo(self, ctx:gramaticaParser.Escritura_archivoContext):
        pass

    # Exit a parse tree produced by gramaticaParser#escritura_archivo.
    def exitEscritura_archivo(self, ctx:gramaticaParser.Escritura_archivoContext):
        pass
